...
from ..core.views import index, user_data, orders, products, addresses, add_product

# Endereços
from ..core.views import create_address, update_address, destroy_address

# Cartões
from ..core.views import create_credit_card, update_card, destroy_card

# Produtos
from ..core.views import show_products, create_product, update_product, destroy_product

#registro

from ..core.views import login, cadastro
